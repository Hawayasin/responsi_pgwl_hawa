...
@section('script')
    <script>
        //Map
        var map = L.map('map').setView([-7.746994322401961, 110.20857160764909], 12);
        ...
        var point = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent = "Nama Geosite: " + feature.properties.name + "<br>" +
        ...
        var polygon = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent = "Nama Formasi: " + feature.properties.name + "<br>" +
                    "Potensi Biodeversity: " + feature.properties.description + "<br>" +
                    "Foto: <img src='{{ asset('storage/images/') }}/" + feature.properties.image +
                    "'class='img-thumbnail' alt=''>" + "<br>";
                // di antara petik ditambahkan feature.properties.image sbg peranan javascript
                layer.on({
