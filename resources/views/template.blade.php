...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="{{ asset('storage/images/dijo.png') }}" alt="Dashboard Logo" width="50" height="70" >    Sambanggo: Sambang Geoheritage Kulon Progo</a>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('table-point') }}">Pusat Geoheritage</a>
            <li><a class="dropdown-item" href="{{ route('table-polyline') }}">Garis Sesar</a>
            <li><a class="dropdown-item" href="{{ route('table-polygon') }}">Area Geoheritage</a>
          </ul>
        </li>
        <li class="nav-item">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Nama: Yasin Manik Hawa</p>
        <p>NIM: 22/506181/SV/22104</p>
        <p>Kelas: Pemrograman Web Lanjut B </p>
      </div>
